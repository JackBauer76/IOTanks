...
Adafruit_MQTT_Publish pirsensor1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/pirsensor2");


// Setup a feed called 'onoff' for subscribing to changes.
Adafruit_MQTT_Subscribe onoffbutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/onoff");
Adafruit_MQTT_Subscribe slider = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/frequency");
/*************************** Sketch Code ************************************/
