/* V2 uses if with interrupt variable
 * new functions for LED lighting patterns introduced
 * works with Nano and Attiny
 * response of interrupt delayed (comes into when in for loop of the functions
 */
